...
namespace Cw12_Lab11_.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPatient,FirstName,LastName,BirdthDate")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPatient,FirstName,LastName,BirdthDate")] Patient patient)
        {
